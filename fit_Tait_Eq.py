...
if isotherms:
	...
	# V0_373K = npy.zeros(len(P))
	# V0_378K = npy.zeros(len(P))
	# V0_383K = npy.zeros(len(P))
	# V0_388K = npy.zeros(len(P))
	# V0_393K = npy.zeros(len(P))
	# V0_398K = npy.zeros(len(P))
	# V0_403K = npy.zeros(len(P))
	# V0_408K = npy.zeros(len(P))
	# V0_413K = npy.zeros(len(P))
	# V0_418K = npy.zeros(len(P))
	# V0_423K = npy.zeros(len(P))
	# V0_428K = npy.zeros(len(P))
	# V0_433K = npy.zeros(len(P))
	# V0_438K = npy.zeros(len(P))
...
if isotherms:
	...
	plt.plot(P,V_373K,'r',lw=linewidth,ls='-',label='373K theory')
