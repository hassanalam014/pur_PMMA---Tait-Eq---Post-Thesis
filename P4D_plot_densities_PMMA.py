...
#==================================================================================
#P versus R plots.
figPUREPMMA=plt.figure(num=None, figsize=(img_vert, img_hori), dpi=img_dpi, facecolor='w', edgecolor='k')
ax = plt.axes()
plt.plot(P0_402K,R0_402K,'ok',ms=markersize,label='PMMA at 402K')
