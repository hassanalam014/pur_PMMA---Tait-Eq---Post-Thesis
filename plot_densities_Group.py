...
if param_set == 'Data1':
	...
	Tstar = Tstar_1
	Rstar = Rstar_1
	temp = ['394','404','414','424','434','444','454','464']

elif param_set == 'Data2':
	Pstar = Pstar_2
	Tstar = Tstar_2
	Rstar = Rstar_2
	temp = ['373','378','383','388','393','398','403','408','413','418','423','428','433','438']

elif param_set == 'Data3':
	Pstar = Pstar_3
	Tstar = Tstar_3
	Rstar = Rstar_3
	temp = ['393','403','413','423','433','443','453','463','473']

elif param_set == 'Data4':
	Pstar = Pstar_4
	Tstar = Tstar_4
	Rstar = Rstar_4
	temp = ['405','420','435','450']
